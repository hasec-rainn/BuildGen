...
/*Themes split up string arrays. Each element is its own description*/
    ...
    var magicshop_overviewArr = magicshop_overivew.split("\n")
    var generalshopArr = generalshop.split("\n")
    var generalshop_overviewArr = generalshop_overview.split("\n")
...
used to pick a random description from a random theme*/
    var theme_overviewArr = [
        spooky_overviewArr,
        magicshop_overviewArr,
        generalshop_overviewArr
    ]
